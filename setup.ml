...
(* OASIS_START *)
(* DO NOT EDIT (digest: 79bdb87d517c2134599ede5dead360b1) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "http://github.com/johanneskloos/jobserver";
          synopsis = "Client/server tools to distribute multiple jobs";
          description =
            Some
              [
                 OASISText.Para
                   "These tools allow you to easily distribute a large number of small tasks over several worker processes. The job server hands out a list of lines, each describing some job, to a number of clients who handle these jobs."
              ];
          categories = [];
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "jobserver.ml"});
               Executable
                 ({
                     cs_name = "jobclient";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "jobclient.ml"});
               Executable
                 ({
                     cs_name = "jobdumper";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "jobdumper.ml"});
               Executable
                 ({
                     cs_name = "jobshell";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "jobshell.ml"});
               Library
                 ({
                     cs_name = "job";
                     cs_data = PropList.Data.create ();
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "http://github.com/johanneskloos/jobserver";
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "\187#\025.Ahe\166k\252r%\1642\248\012";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
